...
def read_config(): 
    ...
    json_dir = join(dirname(realpath(__file__)), cf.get('Directories', 'json_dir')) # gives the absolute path of the  dir
    ...
    return temp_dir, json_dir, ows_url, rest_url, user, password, layername
