...
def wcs_2_array(dir, file, bbox, proj_area, layer, owsurl, layer_cut, unique_id, resturl, user, password):
...
def ast_heatreduction(collection): 
    ...
    #PET current
    currentValues, currentStats, wmsCur = wcs_2_array(caseTmpDir, 'PET_current.tif', bbox, projectArea, "NKWK:PET_current", owsurl, 'PET_current_cut_', unique_id, resturl, user, password)
    #PET potential
    potenValues, potenStats, wmsPoten = wcs_2_array(caseTmpDir, 'PET_potential.tif', bbox, projectArea, "NKWK:PET_potential", owsurl, 'PET_potential_cut_', unique_id, resturl, user, password)
